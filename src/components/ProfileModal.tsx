            ...
            <>
              ...
              <ModalBody className="flex flex-col">
                ...
                <div className="grid grid-cols-2 gap-x-8 gap-y-2">
                  <div>
                    <p>Date of Birth</p>
                    <p className="text-primary-400">{moment(userProfile.dob).format("DD MMM, YYYY")}</p>
                  </div>
                  <div>
                    <p>Mobile No.</p>
                    <p className="text-primary-400">{userProfile.smsMobileNumber}</p>
                  </div>
                  <div>
                    <p>Admission N0.</p>
                    <p className="text-primary-400">{userProfile.admissionNumber}</p>
                  </div>
                  <div>
                    <p>Roll No.</p>
